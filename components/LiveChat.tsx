...
import { Mic, MicOff, Video, VideoOff, Send, Phone, PhoneOff, Loader2, Settings, Volume2, X, ChevronDown } from 'lucide-react';
...
export default function LiveChat() {
    ...
    try {
      ...
      const sessionPromise = ai.live.connect({
        ...
        config: {
          ...
          systemInstruction: "You are a helpful assistant. You can see the user if they enable their camera. You can also think before you speak.",
  ...
  const handleDisconnect = (intentional: boolean) => {
  ...
  const sendText = (e?: React.FormEvent) => {
    ...
    setMessages(prev => [...prev, { id: Date.now().toString(), role: 'user', text: textInput, thought: '', isAudio: false, isComplete: true }]);
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-neutral-950 border border-neutral-800 rounded-lg px-3 py-2 text-neutral-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 disabled:opacity-50"
                >
                ...
                <p className="text-xs text-neutral-500 mt-1">Disconnect to change model.</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 mt-1">Disconnect to change voice.</p>
              </div>
            </div>
                ...
                <div className={`rounded-2xl px-4 py-3 text-sm shadow-lg backdrop-blur-md w-[80vw] ${
                  ...
                  {msg.role === 'model' ? (
                    <div className="flex flex-col gap-2">
                      ...
                      {msg.audioUrl && (
                        <div className="mt-2">
                          <audio controls src={msg.audioUrl} className="h-8 w-full max-w-[200px] opacity-90" />
                        </div>
                      )}
                      {msg.tokens && (
